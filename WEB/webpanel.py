                        ...
                        if finnayl == 0:
                            ...
                            if webhook == None:
                                ...
                                if result[3] == "":
                                    ...
                                    try:
                                        webhooks = DiscordWebhook(username="Roy Vending", avatar_url="https://cdn.discordapp.com/attachments/783489649985060904/950773337787879464/Roy_Vending.png", url=webhook[1])
                                        eb = DiscordEmbed(title='입고 알림', description=f'제품이 입고되었습니다.', color=0x5c6cdf)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=8080)  # 보안 호스트